...
public:
	K_BEGIN_MSG_MAP
		K_MSG_HANDLER(WM_ERASEBKGND,OnEraseBkGnd)
		K_MSG_HANDLER(WM_LBUTTONDOWN,OnLButtonDown)
		K_MSG_HANDLER(WM_LBUTTONUP,OnLButtonUp)
		K_MSG_HANDLER(WM_MOUSEMOVE,OnMouseMove)
		K_MSG_HANDLER(WM_MOUSEWHEEL,OnMouseWheel)
		K_MSG_HANDLER(WM_KEYDOWN,OnKeyDown)
		K_MSG_HANDLER(WM_KEYUP,OnKeyUp)
		K_MSG_HANDLER(WM_PAINT,OnPaint)
		K_MSG_HANDLER(TBM_SETPOS,OnSetPos)
	K_END_MSG_MAP(KTrackBarBase<KXSlider>)
...
public:
	K_BEGIN_MSG_MAP
		...
		K_MSG_HANDLER(WM_KEYUP,OnKeyUp)
		K_MSG_HANDLER(WM_MOUSEWHEEL,OnMouseWheel)
	K_END_MSG_MAP(KTrackBarBase<KRoundSlider>)
...
public:
	...
	K_BEGIN_MSG_MAP
		K_MSG_HANDLER(WM_SIZE,OnSize)
		K_MSG_HANDLER(PBM_SETSTEP,OnSetStep)
		K_MSG_HANDLER(PBM_STEPIT,OnStepIt)
		K_MSG_HANDLER(WM_PAINT,OnPaint)
